    ...
    public function onData($data) {
        ...
        while ($frameStart + 2 <= $dataLen) {
            ...
            if (!$closeFrame && $this->maxMessagePayloadSize > 0
				...
				echo "rfc6455/src/Messaging/MessageBuffer.php: maximum message size of {$this->maxMessagePayloadSize} bytes exceeded (change in ratchet/src/Ratchet/WebSocket/WsServer.php::onOpen())\n";
            }
